...
// ── table existence (για ασφαλή deletes) ─────────────────────
...
const PASS_COL_CANDIDATES = ['password','password_hash','passwd','pass','pwd','user_password','hashed_password'];
...
function looksHashed(s) { return typeof s === 'string' && /^\$2[aby]\$/.test(s); }
